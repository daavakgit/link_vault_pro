      ...
      <div className="flex flex-col gap-4 mt-2">
        ...
        {loading ? (
          ...
          <div className="bg-[#101726] border border-[#1b253b] rounded-2xl p-10 text-center flex flex-col items-center justify-center">
            ...
            <button
              onClick={openAddModal}
              className="bg-[#5852f6] hover:bg-[#4842eb] text-white text-xs font-medium px-4 py-2 rounded-xl transition flex items-center gap-1.5 shadow-lg shadow-indigo-600/25"
            >
