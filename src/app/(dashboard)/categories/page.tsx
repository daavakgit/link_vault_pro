      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-7 gap-3">
        <button
          ...
          className={`p-4 rounded-2xl border text-left flex flex-col justify-between transition-all ${
            selectedCat === 'All'
              ? 'bg-[#5852f6] border-[#6b65ff] text-white shadow-lg shadow-indigo-600/25'
              : 'bg-[#101726] border-[#1b253b] hover:bg-[#182238] text-slate-300'
          }`}
        >
      ...
      {selectedCat === 'All' ? (
        ...
        <div className="flex flex-col gap-4">
          ...
          {getLinksByCategory(selectedCat as CategoryType).length > 0 ? (
            ...
            <div className="bg-[#101726] border border-[#1b253b] rounded-2xl p-10 text-center flex flex-col items-center justify-center">
              <p className="text-slate-400 text-sm mb-4">No links stored under &quot;{selectedCat}&quot; category.</p>
              <button
